...
The application this projectd produces is designed to be run on JBoss Enterprise Application Platform 6 or JBoss AS 7.1. 
...
4. This will deploy `target/TestSpring.war` to the running instance of the server.


Access the application 
---------------------
 
The application will be running at the following URL: <http://localhost:8080/TestSpring/>.
